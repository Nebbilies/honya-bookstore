...
class OrderServiceImplErrorTest {
    ...
    void getOrderByIdThrowsTypedNotFound() {
        ...
        assertThrows(ResourceNotFoundException.class, () -> new OrderServiceImpl(repository).getOrderById(id));
    }
    ...
    void updateOrderStatusThrowsTypedInvalidStatus() {
        ...
        assertThrows(InvalidOrderStatusException.class, () -> new OrderServiceImpl(repository).updateOrderStatus(id, "bad"));
    }
}
